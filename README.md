...
Poker taught me expected value optimization and Bayesian decision-making under pressure. Sales taught me that the best close is genuine understanding of what the other person needs. Engineering taught me that process beats outcome over a large enough sample size.

I build systems that produce good results repeatedly. Whether that's a data pipeline, an attribution model, or an autonomous agent — you optimize for the system, not the result.
...
*I build the system AND close the deal. [Let's talk.](mailto:christianbourlier@gmail.com)*
